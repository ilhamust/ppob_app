...
class BayarToken4 extends StatelessWidget {
  const BayarToken4({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const KotakBayar(text1: "Nominal 100.000", text2: "Token Listrik Rp. 100.000", text3: "Rp. 102.000",),
